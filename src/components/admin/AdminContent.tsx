...
const SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      { key: 'accroche',  label: 'Accroche (petit texte coloré)' },
      { key: 'titre1',    label: 'Titre – ligne 1' },
      { key: 'titre2',    label: 'Titre – ligne 2 (colorée)' },
      { key: 'sousTitre', label: 'Paragraphe intro', multiline: true },
    ],
  },
  {
    ...
    fields: [
      { key: 'titre', label: 'Titre de la section' },
      { key: 'b1',    label: 'Bénéfice 1 (📈)' },
      { key: 'b2',    label: 'Bénéfice 2 (⚡)' },
      { key: 'b3',    label: 'Bénéfice 3 (🤝)' },
      { key: 'b4',    label: 'Bénéfice 4 (🧠)' },
      { key: 'b5',    label: 'Bénéfice 5 (😌)' },
      { key: 'b6',    label: 'Bénéfice 6 (🏆)' },
    ],
  },
  {
    ...
    fields: [
      { key: 'titre',     label: 'Titre de la section' },
      { key: 'sousTitre', label: 'Sous-titre de la section', multiline: true },
      { key: 'offre1_titre', label: 'Offre 1 – Titre' },
      { key: 'offre1_desc',  label: 'Offre 1 – Description', multiline: true },
      { key: 'offre1_d1',   label: 'Offre 1 – Détail 1' },
      { key: 'offre1_d2',   label: 'Offre 1 – Détail 2' },
      { key: 'offre1_d3',   label: 'Offre 1 – Détail 3' },
      { key: 'offre2_titre', label: 'Offre 2 – Titre' },
      { key: 'offre2_desc',  label: 'Offre 2 – Description', multiline: true },
      { key: 'offre2_d1',   label: 'Offre 2 – Détail 1' },
      { key: 'offre2_d2',   label: 'Offre 2 – Détail 2' },
      { key: 'offre2_d3',   label: 'Offre 2 – Détail 3' },
      { key: 'offre3_titre', label: 'Offre 3 – Titre' },
      { key: 'offre3_desc',  label: 'Offre 3 – Description', multiline: true },
      { key: 'offre3_d1',   label: 'Offre 3 – Détail 1' },
      { key: 'offre3_d2',   label: 'Offre 3 – Détail 2' },
      { key: 'offre3_d3',   label: 'Offre 3 – Détail 3' },
      { key: 'offre4_titre', label: 'Offre 4 – Titre' },
      { key: 'offre4_desc',  label: 'Offre 4 – Description', multiline: true },
      { key: 'offre4_d1',   label: 'Offre 4 – Détail 1' },
      { key: 'offre4_d2',   label: 'Offre 4 – Détail 2' },
      { key: 'offre4_d3',   label: 'Offre 4 – Détail 3' },
    ],
  },
  {
    key: 'contact',
