...
const ALL_DEFAULTS: Record<string, Record<string, string>> = {
  ...
  coaching: {
    ...
    points:   "Évolution professionnelle|Atteinte d'un objectif|Confiance en soi|Accompagnement changements de vie",
  },
  sophrologie: {
    label:    'Méthode',
    titre:    'Sophrologie',
    ...
    cta:      'Je veux essayer',
    points:   'Gestion du stress & anxiété|Préparation mentale|Accompagnement de la douleur|Travail de la concentration|Connexion au corps',
  },
  methodes: {
    label: 'Mes méthodes',
  ...
  quiSection: {
    ...
    profil1_emoji: '🌀', profil1_titre: 'Vous traversez une transition',           profil1_desc: "Changement de poste, reconversion, séparation, déménagement… Vous cherchez à retrouver un cap et à avancer avec clarté.",
    profil2_emoji: '⚡', profil2_titre: 'Vous êtes débordé·e ou épuisé·e',         profil2_desc: "Stress chronique, surcharge mentale, difficulté à déconnecter. Vous avez besoin d'un espace et d'outils concrets pour retrouver du calme.",
    profil3_emoji: '🌱', profil3_titre: 'Vous souhaitez vous développer',          profil3_desc: "Confiance en soi, affirmation de soi, gestion des émotions. Vous voulez mieux vous connaître et prendre conscience de vos ressources.",
    profil4_emoji: '🎯', profil4_titre: "Vous avez envie d'atteindre un objectif", profil4_desc: "Examen, compétition, prise de parole, projet de vie. Vous souhaitez préparer mentalement une étape importante.",
  },
  faq: {
...
const SECTIONS: {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'cta',      label: 'Texte du bouton (ex : "Réserver une séance")' },
      { key: 'points',   label: 'Liste de points — séparés par | (ex : Confiance en soi|Prise de décision)' },
    ],
  },
  {
    key: 'sophrologie',
    ...
    fields: [
      ...
      { key: 'accroche', label: 'Sous-titre', hasStyle: true, hasAlign: true },
      { key: 'texte',    label: 'Texte',      hasAlign: true },
      { key: 'cta',      label: 'Texte du bouton (ex : "Je veux essayer")' },
      { key: 'points',   label: 'Liste de points — séparés par | (ex : Gestion du stress|Préparation mentale)' },
    ],
  },
  {
    key: 'methodes',
  ...
  },
  {
    ...
    fields: [
      ...
      // 4 cartes profil
      { key: 'profil1_emoji', label: 'Carte 1 – Emoji' },
      { key: 'profil1_titre', label: 'Carte 1 – Titre' },
      { key: 'profil1_desc',  label: 'Carte 1 – Description' },
      { key: 'profil2_emoji', label: 'Carte 2 – Emoji' },
      { key: 'profil2_titre', label: 'Carte 2 – Titre' },
      { key: 'profil2_desc',  label: 'Carte 2 – Description' },
      { key: 'profil3_emoji', label: 'Carte 3 – Emoji' },
      { key: 'profil3_titre', label: 'Carte 3 – Titre' },
      { key: 'profil3_desc',  label: 'Carte 3 – Description' },
      { key: 'profil4_emoji', label: 'Carte 4 – Emoji' },
      { key: 'profil4_titre', label: 'Carte 4 – Titre' },
      { key: 'profil4_desc',  label: 'Carte 4 – Description' },
    ],
  },
  {
    key: 'rdvForm',
