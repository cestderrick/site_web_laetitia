...
const EFFECTIFS = ['1–10', '11–50', '51–200', '200+']
const BESOINS   = ['Atelier sophrologie', "Coaching d'équipe", 'Programme bien-être', 'Conférence / Sensibilisation', 'Autre']
const FORMATS   = ['Présentiel Lyon', 'Présentiel Giez', 'Visioconférence', 'Les deux']
    ...
    <form onSubmit={handleSubmit} className="max-w-2xl mx-auto bg-blanc-casse rounded-2xl p-8 shadow-sm space-y-5">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <div>
          ...
          <input required type="text" placeholder="Acme SAS"
            value={form.societe} onChange={e => set('societe', e.target.value)}
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <div>
          ...
          <input required type="email" placeholder="marie@acme.fr"
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <div>
          ...
          <select required value={form.effectif} onChange={e => set('effectif', e.target.value)}
            className="w-full px-4 py-3 rounded-xl border border-rose-pastel/40 bg-white focus:outline-none focus:border-rose-saumon text-texte">
        ...
        <div>
          ...
          <select required value={form.besoin} onChange={e => set('besoin', e.target.value)}
            className="w-full px-4 py-3 rounded-xl border border-rose-pastel/40 bg-white focus:outline-none focus:border-rose-saumon text-texte">
            <option value="">-- Choisir --</option>
      ...
      <div>
        ...
        <textarea rows={4}
          placeholder="Contexte, objectifs, contraintes de calendrier, budget approximatif…"
      ...
      <p className="text-center text-xs text-texte/40">Réponse sous 48h · Devis gratuit et sans engagement</p>
    </form>
  )
}
