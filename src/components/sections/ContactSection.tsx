...
/** Transforme "06 64 43 87 47" en "tel:+33664438747" */
function toTelHref(tel: string): string {
  const digits = tel.replace(/\s/g, '').replace(/\./g, '')
...
export default function ContactSection() {
  ...
  const coordonnees = [
    { icone: '📍', titre: 'Adresse',   valeur: adresse,   href: undefined },
    { icone: '📧', titre: 'Email',     valeur: email,     href: `mailto:${email}` },
    { icone: '📞', titre: 'Téléphone', valeur: telephone, href: toTelHref(telephone) },
  ]
    ...
    <section id="contact" className="section-padding bg-blanc-casse scroll-mt-24">
      <div className="container-max">
        <div className="text-center mb-16">
          <p className="text-rose-saumon text-xs font-semibold tracking-widest uppercase mb-3">Contact</p>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            {sent ? (
              <div className="bg-vert-pastel/20 border border-vert-pastel rounded-2xl p-8 text-center">
                ...
                <p className="text-texte/70">Merci pour votre message. Je vous réponds dans les plus brefs délais.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-texte mb-1" htmlFor="nom">Nom & Prénom *</label>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-texte mb-1" htmlFor="telephone">Téléphone</label>
                ...
                <div>
                  <label className="block text-sm font-medium text-texte mb-1" htmlFor="email">Email *</label>
          ...
          <div className="flex flex-col gap-8 justify-center">
            {coordonnees.map(({ icone, titre, valeur, href }) => (
